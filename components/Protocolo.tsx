...
export default function Protocolo({ locked, onCtaClick }: Props) {
  ...
  return (
    <section className="relative bg-cream text-carbon px-6 md:px-10 py-24 md:py-32 border-t border-carbon/10">
      ...
      >
        ...
        <div className="mt-20 text-center">
          ...
          <button
            ...
            onClick={onCtaClick}
            disabled={locked}
            className="mt-8 min-h-12 rounded-full bg-deep px-10 py-3 text-base font-semibold text-white transition disabled:cursor-not-allowed disabled:opacity-60 hover:bg-deep/90 active:scale-[0.98]"
          >
            {protocolo.ctaBoton}
          </button>
        </div>
